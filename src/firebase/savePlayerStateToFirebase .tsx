...
const savePlayerStateToFirebase = async (playerId: string, player: Player, inventory: Inventory) => {
 
  const playerRef = ref(database, `players/${playerId}`);
  const inventoryRef = ref(database, `players/${playerId}/${player.inventoryId}`);
