...
const generateRandomStatRequirements = (
  equipLevel: number,
): { [stat: string]: number } => {
  ...
  selectedStats.forEach((stat) => {
    statRequirements[stat] = Math.max(
      5,
      equipLevel - 3 + Math.floor(Math.random() * 6),
    );
  });
    ...
    <div>
      ...
      {armor && (
        <div>
          ...
          <p>
            <strong>Valor de armadura:</strong> {armor.armorValue}
          </p>
          <p>
            <strong>Rareza:</strong> {armor.rarity}
          </p>
          <p>
            <strong>Material:</strong> {armor.material}
          </p>
          <p>
            <strong>Peso:</strong> {armor.weight} kg
          </p>
          <p>
            <strong>Costo:</strong> {armor.cost} monedas
          </p>
          <p>
            <strong>Nivel de equipo:</strong> {armor.equipLevel}
          </p>
        </div>
      )}
    </div>
